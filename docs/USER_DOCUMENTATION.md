...
2. Create custom dashboard templates:
   - **Template Creation**: Define custom metrics and periods
   - **CSV Import**: Upload spreadsheet data directly
   - **Progress Tracking**: Monitor target vs actual performance
   - **Visual Dashboards**: Interactive charts and progress bars
...
3. Select period type (Weekly, Monthly, Quarterly, Yearly)
4. Choose visibility settings (Private/Public)
5. Click **"Create Template"**

#### Importing CSV Data

1. Select a template from the list
2. Click the **upload icon** (📤) next to the template
...
4. The system will automatically:
   - Parse metric names from column headers
